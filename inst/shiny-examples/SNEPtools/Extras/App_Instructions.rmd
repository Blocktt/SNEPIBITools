...
* Check your taxa list against the ‘FinalID’ field in the [TaxaTranslator table](https://github.com/Blocktt/SNEPtools/tree/main/Data_Prep). The use of consistent nomenclature is encouraged.
